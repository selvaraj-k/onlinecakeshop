            ...
            <div class="container-fluid dashboard-content">    
                ...
                <div class="row mx-5 justify-content-center">
                    <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12 text-center">
                    	<div class="card">
                    		<div class="card-body">
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d426.38529399368423!2d77.62344155162035!3d10.60078385201188!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ba9e92bf88defc9%3A0xbd0f7b7709b40b93!2sandavar%20backery!5e1!3m2!1sen!2sin!4v1653919084797!5m2!1sen!2sin" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
                                <h3 class="text-secondary font-italic mt-3 text-left">Address:</h3>
                                <p class="text-secondary font-italic text-left">
				   Dailyfresh Bakery, Opposite Porulur Bus Stand,Thoppampatti-Kallimandhayam Road,Porulur,624616
                                </p>
                                <h3 class="text-secondary font-italic mt-3 text-left">Email:</h3>
                                <p class="text-secondary font-italic text-left">
                                     velmanikpvs@gmail.com
                                </p>
                                <h3 class="text-secondary font-italic mt-3 text-left">Call on:</h3>
                                <p class="text-secondary font-italic text-left">
                                     (+91) 9655790073 / 9655337678
                                </p>
                    		</div>
                    	</div>
                    </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            Copyright © 2022 Concept. All rights reserved. Dashboard by <a href="#">selvarajk</a>.
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
